...
<main class="main-content">
    ...
    <div class="card mb-sm">
        <h2>Edit Supplier #<?= $supplier_id ?></h2>
    </div>
    ...
    <div class="card">
        <form method="POST" class="form-grid">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" required value="<?= htmlspecialchars($supplier['name']) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="reliability_score" name="reliability_score" step="0.01" min="0" max="10" value="<?= number_format($supplier['reliability_score'], 2) ?>">
            </div>
