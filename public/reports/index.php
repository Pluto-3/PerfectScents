...
try {
    ...
    $marketing_roi = ($marketing_data['total_sales_generated'] ?? 0) - ($marketing_data['total_budget'] ?? 0);
...
<main class="main-content">
    ...
    <div class="card mb-sm">
        ...
        <a href="purchases_report.php" class="btn btn-primary">Purchases Report</a>
        <a href="marketing_report.php" class="btn btn-primary">Marketing Report</a>
    ...
    <div class="card mb-md">
        <h3>Marketing ROI</h3>
        <p>Total Budget: <?= CURRENCY ?> <?= number_format($marketing_data['total_budget'] ?? 0, 2) ?> | 
           Sales Generated: <?= CURRENCY ?> <?= number_format($marketing_data['total_sales_generated'] ?? 0, 2) ?> | 
           ROI: <?= CURRENCY ?> <?= number_format($marketing_roi, 2) ?></p>
    </div>
